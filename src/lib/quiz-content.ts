...
export const RESULTS = {
  DASHER: {
    ...
    shareText: "I'm Dasher, the speed demon of AI builders! 🚀 Take the quiz to find your AI builder reindeer spirit!"
  },
  BLITZEN: {
    id: "BLITZEN",
    ...
    shareText: "I'm Blitzen, the energetic innovator! ⚡ Take the quiz to find your AI builder reindeer spirit!"
  },
  PRANCER: {
    id: "PRANCER",
    ...
    shareText: "I'm Prancer, the perfectionist of AI builders! ✨ Take the quiz to find your AI builder reindeer spirit!"
  },
  DONNER: {
    id: "DONNER",
    ...
    shareText: "I'm Donner, the strategic leader! 🎯 Take the quiz to find your AI builder reindeer spirit!"
  },
  CUPID: {
    id: "CUPID",
    ...
    shareText: "I'm Cupid, the community champion! ❤️ Take the quiz to find your AI builder reindeer spirit!"
  },
  RUDOLPH: {
    id: "RUDOLPH",
    ...
    shareText: "I'm Rudolph, the problem solver! 🔦 Take the quiz to find your AI builder reindeer spirit!"
  },
  VIXEN: {
    id: "VIXEN",
    ...
    shareText: "I'm Vixen, the creative visionary! 💫 Take the quiz to find your AI builder reindeer spirit!"
  },
  COMET: {
    id: "COMET",
